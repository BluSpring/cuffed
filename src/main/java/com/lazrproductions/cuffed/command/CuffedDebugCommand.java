            ...
            Commands.literal("cuffed").requires((source) -> {
                ...
                .then(Commands.literal("get")
                    .then(Commands.argument("item", ItemArgument.item(ctx))
                        .then(Commands.argument("type", RestraintTypeArgument.restraintType())
        ...
        try {
            ...
            if (sender != null) {
                ...
                if (stack != null && !stack.isEmpty()) {
                    ...
                    if (r != null) {
                        sender.sendSystemMessage(Component.literal("Found the following restraint for the given item and restraintType:\n" + r.serializeNBT()));
                    } else {
                        sender.sendSystemMessage(Component.literal("Could not find a restraint for that item and restraintType!"));
                    }
                    return 1;
                }
